...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__barba_core__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__barba_css__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__routes_project__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__routes_post__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__routes_page__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__routes_projects__ = __webpack_require__(15);
...
window.routes = new __WEBPACK_IMPORTED_MODULE_2__util_Router__["a" /* default */]({
  about: __WEBPACK_IMPORTED_MODULE_3__routes_about__["a" /* default */],
  // All pages
  common: __WEBPACK_IMPORTED_MODULE_4__routes_common__["a" /* default */],
  // Home page
  home: __WEBPACK_IMPORTED_MODULE_5__routes_home__["a" /* default */],
  // Projects index page
  projects: __WEBPACK_IMPORTED_MODULE_9__routes_projects__["a" /* default */],
  // Project pages
  singleProjects: __WEBPACK_IMPORTED_MODULE_6__routes_project__["a" /* default */],
  // Post pages
  singlePost: __WEBPACK_IMPORTED_MODULE_7__routes_post__["a" /* default */],
    // Pages
  page: __WEBPACK_IMPORTED_MODULE_8__routes_page__["a" /* default */],
});
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  try {
    ...
    __WEBPACK_IMPORTED_MODULE_0__barba_core___default.a.hooks.before(function () {
      navTrigger.checked = false;
      __WEBPACK_IMPORTED_MODULE_0__barba_core___default.a.wrapper.classList.add('is-animating');
    });

    __WEBPACK_IMPORTED_MODULE_0__barba_core___default.a.hooks.after(function () {
      __WEBPACK_IMPORTED_MODULE_0__barba_core___default.a.wrapper.classList.remove('is-animating');
    ...
    __WEBPACK_IMPORTED_MODULE_0__barba_core___default.a.hooks.enter(function () {
 ...
 return trigger == 'back' || trigger == 'forward' },
          ...
          afterLeave: function afterLeave() {
            __WEBPACK_IMPORTED_MODULE_0__barba_core___default.a.wrapper.scrollTop = 0;
          },
        },
        {
          name: 'left',
          from: {
            custom: function (ref) {
            var trigger = ref.trigger;
 return trigger.classList.contains('next-project')},
          },
          sync: true,
          before: function before(data) {
            var currentScroll = __WEBPACK_IMPORTED_MODULE_0__barba_core___default.a.wrapper.scrollTop;
            data.next.container.style.top = currentScroll + 'px';
          },
          after: function after(data) {
            __WEBPACK_IMPORTED_MODULE_0__barba_core___default.a.wrapper.scrollTop = data.next.container.offsetTop;
          },
        },
        {
            name: 'right',
            from: {
              custom: function (ref) {
              var trigger = ref.trigger;
 return trigger.classList.contains('previous-project') },
            },
            sync: true,
            before: function before(data) {
              var currentScroll = __WEBPACK_IMPORTED_MODULE_0__barba_core___default.a.wrapper.scrollTop;
        ...
        },
        {
          ...
          from: {
            custom: function (ref) {
            var trigger = ref.trigger;
 return (trigger.classList.contains('about-people--grid--item') || trigger.classList.contains('about-services--list--item--anchor')) },
          },
          sync: true,
          before: function before(data) {
 ...
 return trigger != 'back' && trigger != 'forward' },
          ...
          before: function before(e) {
            if(e.trigger.classList.contains('brand')){
              var triggerBounds = e.trigger.getBoundingClientRect();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_inView__ = __webpack_require__(0);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  finalize: function finalize() {
    Object(__WEBPACK_IMPORTED_MODULE_0__util_inView__["a" /* default */])('.about-people--grid--item', 0.2);
  },
});
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  finalize: function finalize() {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__util_inView__["a" /* default */])('.projects-grid--project', 0.2);
    Object(__WEBPACK_IMPORTED_MODULE_0__util_inView__["a" /* default */])('.wp-block-image', 0.2);
    Object(__WEBPACK_IMPORTED_MODULE_0__util_inView__["a" /* default */])('.scraps--item', 0.2);
  },
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_typesplit__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_inView__ = __webpack_require__(0);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  finalize: function finalize() {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1__util_inView__["a" /* default */])('.home-scrapbook', 0.1);
