  ...
  <div class="container">
    ...
    <div class="home-projects--wrapper">
      ...
      <a class="home-projects--project">
        <img class="home-projects--image" src="@asset('images/project1.jpg')" alt="">
        <h3 class="home-projects--heading">Open House</h3>
      ...
      <a class="home-projects--project">
        <img class="home-projects--image" src="@asset('images/project2.jpg')" alt="">
        <h3 class="home-projects--heading">Godstow</h3>
      ...
      <a class="home-projects--project">
        <img class="home-projects--image" src="@asset('images/project3.jpg')" alt="">
        <h3 class="home-projects--heading">Agloo</h3>
        <p class="home-projects--excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt et dolore magna aliqua.</p>
      </a>

      <a class="home-projects--project">
        <img class="home-projects--image" src="@asset('images/project4.jpg')')" alt="">
        <h3 class="home-projects--heading">House of the Commons</h3>
        <p class="home-projects--excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt et dolore magna aliqua.</p>
      </a>

      <a class="home-projects--project">
        <img class="home-projects--image" src="@asset('images/project5.jpg')" alt="">
        <h3 class="home-projects--heading">Wooton Thatched Barn</h3>
        <p class="home-projects--excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt et dolore magna aliqua.</p>
      </a>

      <a class="home-projects--project">
        <img class="home-projects--image" src="@asset('images/project6.jpg')" alt="">
        <h3 class="home-projects--heading">Makespace Oxford</h3>
        <p class="home-projects--excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
      </a>
